...
const AddQuestion = (props) => {
  ...
  const handleFileRead = (e) => {
    ...
    fileName = utility.ReplaceAll(fileName, "'", '%27');
    fileName = utility.ReplaceAll(fileName, "/\(/g", '%28');
    fileName = utility.ReplaceAll(fileName, "/\)/g", '%29');
    fileName = utility.ReplaceAll(fileName, "/\*/g", '%2A');
    fileName = utility.ReplaceAll(fileName, "/%20/g", '+');
