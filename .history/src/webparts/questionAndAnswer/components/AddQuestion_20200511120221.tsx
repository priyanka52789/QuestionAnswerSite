...
const AddQuestion = (props) => {
  ...
  function codeOnClick() {
    let soueceCodeStr =
      "<div class='mydiv'><div class='top'>Top sample content</div><div class='bottom'>Bottom sample content</div></div>";
    const qlEditor = document.querySelector(".ql-editor");
    const myDiv = document.createElement("div");
    myDiv.innerHTML = noNewlines;
    qlEditor2.appendChild(myDiv);
