...
const AddQuestion = (props) => {
  ...
  function codeOnClick() {
    let soueceCodeStr = "<div class='mydiv'>sample content</div>";
  ...
  return (
    <div>
      ...
      />
      <div dangerouslySetInnerHTML={renderEditorContent()} />
      ...
      <PrimaryButton onClick={() => saveOnClick()}>Save</PrimaryButton>
      <PrimaryButton onClick={() => codeOnClick()}>
        Insert Source Code
      </PrimaryButton>
      <PrimaryButton onClick={() => toggleEditOnClick()}>
        Toggle Edit
      </PrimaryButton>
    </div>
  );
